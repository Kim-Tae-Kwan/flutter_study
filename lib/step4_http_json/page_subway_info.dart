...
class MainPageState extends State<MainPage> {
  TextEditingController _stationController = TextEditingController(text: api.defaultState);
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                OutlinedButton(onPressed: _onClick, child: Text('조회'))
              ],
            ),
          ),
          SizedBox(height: 10,),
          Padding(padding: EdgeInsets.fromLTRB(20, 0, 0, 0), child: Text('도착 정보'),),
          SizedBox(height: 10,),
          Flexible(
